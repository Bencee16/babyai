...
class ObssPreprocessor:
    def __init__(self, model_name, obs_type, load_vocab_from=None, room_size=None):
        ...
        if obs_type == "egocentric":
            ...
            self.obs_space = {
                "image": room_size*room_size*3,
                "instr": self.vocab.max_size
            }
        else:
            raise ValueError('The observation type must be either egocentric or full')

...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument("--class-weights", default=False,
        ...
        self.add_argument("--instr-dim", type=int, default=128,
                          help="dimensionality of the instruction GRU")
        self.add_argument("--message_dim", type=int, default=128,
                          help="dimensionality of the message embedding")
        ...
        self.add_argument("--comm-freq", default=1,
                          help="communication frequency (default: 1)")
        self.add_argument("--message-length", type=int, default=2,
